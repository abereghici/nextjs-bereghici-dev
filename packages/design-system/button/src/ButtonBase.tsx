...
export const BaseButton = styled.button<{
  ...
  ({ size, variant, shape, isLoading, isSelected, focusVisible, disabled }) => {
    return {
      ...
      ...getVariantStyles({ variant, isLoading, isSelected, disabled }),
...
function getFontStyles({ size }: { size: Size }) {
  switch (size) {
    case 'mini':
...
function getBorderRadiiStyles({ size, shape }: { size: Size; shape: Shape }) {
...
function getPaddingStyles({ size, shape }: { size: Size; shape: Shape }) {
