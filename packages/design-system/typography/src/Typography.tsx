...
import { Block, BlockProps } from '@bereghici/design-system.block';
import type { Palette, Typography } from '@bereghici/design-system.theme';
...
export const DisplayLarge = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const DisplayMedium = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const DisplaySmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const DisplayXSmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const HeadingXXLarge = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'h1'}
      {...props}
...
export const HeadingXLarge = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'h2'}
      {...props}
...
export const HeadingLarge = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'h3'}
      {...props}
...
export const HeadingMedium = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'h4'}
      {...props}
...
export const HeadingSmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'h5'}
      {...props}
...
export const HeadingXSmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'h6'}
      {...props}
...
export const LabelLarge = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const LabelMedium = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const LabelSmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const LabelXSmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const ParagraphLarge = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'p'}
      {...props}
...
export const ParagraphMedium = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'p'}
      {...props}
...
export const ParagraphSmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'p'}
      {...props}
...
export const ParagraphXSmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'p'}
      {...props}
...
export const MonoDisplayLarge = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const MonoDisplayMedium = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const MonoDisplaySmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const MonoDisplayXSmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const MonoHeadingXXLarge = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'h1'}
      {...props}
...
export const MonoHeadingXLarge = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'h2'}
      {...props}
...
export const MonoHeadingLarge = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'h3'}
      {...props}
...
export const MonoHeadingMedium = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'h4'}
      {...props}
...
export const MonoHeadingSmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'h5'}
      {...props}
...
export const MonoHeadingXSmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'h6'}
      {...props}
...
export const MonoLabelLarge = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const MonoLabelMedium = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const MonoLabelSmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const MonoLabelXSmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      {...props}
...
export const MonoParagraphLarge = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'p'}
      {...props}
...
export const MonoParagraphMedium = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'p'}
      {...props}
...
export const MonoParagraphSmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'p'}
      {...props}
...
export const MonoParagraphXSmall = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => (
    <Block
      as={props.as ?? 'p'}
      {...props}
