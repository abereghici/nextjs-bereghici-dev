---
title: React Versions — The Newest Features of React 16.6 Explained for Everyday Use
description: We’re living in pretty eventful times for React. Late December 2018 saw the release of version 16.7 which included an important performance bug fix for “React.lazy”. But, no other API (application programming interface) changes were delivered. For that reason, I’m doing a deep dive into React version 16.6, released in October 2018, just a few days before React Day in Berlin.
date: '2019-07-18'
image: /static/images/react-versions-the-newest-features-of-react.jpg
---

<Image
  alt={`React Code`}
  src={`/static/images/react-versions-the-newest-features-of-react.jpg`}
  blurDataURL={`/static/images/react-versions-the-newest-features-of-react.jpg`}
  width={800}
  height={400}
  priority
  placeholder="blur"
...
For that reason, I’m doing a deep dive into React version 16.6, released in October 2018, just a few days before [React Day](https://reactday.berlin/) in Berlin.
...
If you’d like an in-depth exploration of these features, [check out this video](https://www.youtube.com/watch?time_continue=389&v=p8v9X2TNQKA) from React Day Berlin.
