...
<Image
  alt={`Rushjs logo`}
  src={`/static/images/build-a-scalable-front-end-with-rush-monorepo-and-react-part1.jpg`}
  blurDataURL={`/static/images/build-a-scalable-front-end-with-rush-monorepo-and-react-part1.jpg`}
  width={800}
  height={400}
  priority
  placeholder="blur"
...
- [Part 2](/blog//blog/build-a-scalable-front-end-with-rush-monorepo-and-react--webpack+jest):
