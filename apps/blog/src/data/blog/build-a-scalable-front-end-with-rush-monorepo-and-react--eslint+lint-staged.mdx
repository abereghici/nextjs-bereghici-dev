...
date: '2021-08-18'
image: /static/images/build-a-scalable-front-end-with-rush-monorepo-and-react-part3.jpg
---

<Image
  alt={`Rushjs logo`}
  src={`/static/images/build-a-scalable-front-end-with-rush-monorepo-and-react-part3.jpg`}
  blurDataURL={`/static/images/build-a-scalable-front-end-with-rush-monorepo-and-react-part3.jpg`}
  width={800}
  height={400}
  priority
  placeholder="blur"
